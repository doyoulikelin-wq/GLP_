...
- [`resources/manifests/`](resources/manifests/)：会话和资源机器可读索引。
- [`main/repository_policy/`](main/repository_policy/)：持续使用的仓库政策检查。
- [`tools/one_off/`](tools/one_off/)：仅在特定日期执行的迁移或索引脚本。
